...
export default function ServicioTecnicoPage() {
  ...
  const submitTicket = async () => {
    ...
    const ticketUrl = `${typeof window !== 'undefined' ? window.location.origin : 'https://addani-tienda.vercel.app'}/ticket/${ticket.ticket_code}`;
    const msg = [
              ...
              {step === 'done' && (
                <div className="bg-gradient-to-br from-amber-500/10 to-zinc-900 border border-amber-500/30 rounded-3xl p-8 text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 justify-center">
                    <Link href={`/ticket/${ticketCode}`}
                      className="bg-amber-400 hover:bg-amber-300 text-black px-5 py-3 rounded-xl font-bold text-sm flex items-center justify-center gap-2">
